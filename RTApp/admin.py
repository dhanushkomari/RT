...
from .models import Standard, Section, Subject, Topic, Configuration, Detail
...
class DetailAdmin(admin.ModelAdmin):
    list_display = ['detail_id', 'created_at', 'standard', 'section', 'subject', 'topic', 'total_time', 'teaching', 'questioning']
    list_per_page =20
